				...
				>
					...
					>
						<div class="text-base-medium text-ink-gray-9 leading-none">
							...
							<span v-else> Addis Chicken Training </span>
						</div>
						<div
...
const clearDemoDataConfirmation = () => {
	$dialog({
		...
		message: __(
			'Are you sure you want to clear the demo data? This would delete the course "A guide to Addis Chicken Training" along with all its associated data. This action cannot be undone.'
		),
		actions: [
			{
				label: __('Confirm'),
