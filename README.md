...
<img src=".github/lms-logo.png" alt="Addis Chicken Training logo" width="80" height="80"/>
<h1>Addis Chicken Training</h1>

**Open Source Learning Management System for Poultry Training**
...
<br />
<div align="center">
	<a href="https://addispoultry.com">Website</a>
	-
	<a href="https://docs.frappe.io/learning">Documentation</a>
</div>

## Addis Chicken Training
Addis Chicken Training is a learning management system built for poultry farmers, trainers, and extension workers in Ethiopia. It helps bring structured poultry training content to farmers through courses, live classes, quizzes, and certifications.

### Motivation
In 2025, we saw the need for a simple, accessible learning management system tailored for poultry training in Ethiopia. Existing platforms were either too complex or not suited for agricultural training. Addis Chicken Training was built to address this gap — providing a simple platform for poultry trainers to create courses, conduct live classes, and certify farmers.
...
Follow these steps to set up Addis Chicken Training in production:
...
The script will set up a production-ready instance of Addis Chicken Training with all the necessary configurations in about 5 minutes.
