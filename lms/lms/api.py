...
def get_pwa_manifest():
	title = frappe.db.get_single_value("Website Settings", "app_name") or "Addis Chicken Training"
...
def clear_demo_data():
	frappe.only_for("Moderator")
	quiz_title = "Do you know Addis Chicken Training?"
	if frappe.db.exists("LMS Quiz", {"title": quiz_title}):
		frappe.db.delete("LMS Quiz", {"title": quiz_title})

	demo_course = frappe.get_all("LMS Course", {"title": "A guide to Addis Chicken Training"}, pluck="name")
