...
def create_course():
	title = "A guide to Addis Chicken Training"
	filters = {"title": title}
	...
	course.update(
		{
			...
			"short_introduction": "Learn the basics of Addis Chicken Training and how to get started with your very first course.",
			"image": "/assets/lms/images/course_card.jpeg",
		}
	)

	course.description = """
		This course will cover the fundamentals of Addis Chicken Training, including how to create and manage courses, enroll students, and track progress. You will learn about the following key features of the app:
		<br>
		<h3>Key Features</h3>
		<br>
...
def create_intro_lesson_2(course):
	title = "What is Addis Chicken Training?"
	chapter = get_chapter(course, "Introduction")
	content = """
...
def create_quiz():
	title = "Do you know Addis Chicken Training?"
	filters = {"title": title}
	...
	questions.append(
		create_quiz_questions(
			"What is Addis Chicken Training primarily used for?",
			"Project Management",
			False,
			"Learning Management",
			True,
	...
	questions.append(
		create_quiz_questions(
			"Which of the following can be added to a course in Addis Chicken Training?",
			"Lessons",
			True,
			"Issues",
			False,
	...
	questions.append(
		create_quiz_questions(
			"What is the top-level structure in Addis Chicken Training?", "Chapter", False, "Course", True
		)
	)
	questions.append(
		create_quiz_questions("Can you create quizzes in Addis Chicken Training?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
	...
	questions.append(
		create_quiz_questions("Can you track learner progress in Addis Chicken Training?", "Yes", True, "No", False)
	)
	questions.append(
		create_quiz_questions(
			"What is the purpose of a batch in Addis Chicken Training?",
			"To group learners",
			True,
	...
	questions.append(
		create_quiz_questions(
			"How can you create custom certificates in Addis Chicken Training?",
...
def create_reviews(course, student):
	...
	review.rating = 0.8
	review.review = "This is a great course to get started with Addis Chicken Training. The content is well-structured and easy to follow."
	review.save()
		...
		"blocks": [
			{
				...
				"type": "paragraph",
				"data": {
					"text": "Addis Chicken Training allows you to embed videos in lessons using popular video hosting platforms."
				},
			},
			{
				"id": "1ooWPn5Zmq",
				"type": "paragraph",
				"data": {
					"text": "You don't need to upload videos directly into Addis Chicken Training - simply copy the video URL from your preferred provider and paste it into the Lesson Editor."
				},
			},
			{
				"id": "tCJD0yMAGd",
				"type": "paragraph",
				"data": {
					"text": "Addis Chicken Training automatically detects the video source and embeds it for learners."
				},
			},
